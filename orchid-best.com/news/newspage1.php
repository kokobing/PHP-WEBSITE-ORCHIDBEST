...
<div class="txt"  id="aboutcontentright_navi">您现在的位置：<a href="/" class="link_aboutnavi">首页</a> > <a href="/news/news.php?ndir=<?=$onenews[id_newsdir];?>" class="link_aboutnavi"><?=$onenewsdir[name];?></a> > 新闻内容</div>
